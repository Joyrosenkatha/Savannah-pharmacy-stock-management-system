...
if(isset($_POST['updatebtn'])){
    ...
    $updateQuery = $link->query("UPDATE stocks_table SET Med_id =  '".$_POST['Med_id']."', Quantity_in_Stock =  '".$_POST['Quantity_in_Stock']."', Expiry_date =  '".$_POST['Expiry_date']."', Supplier_id = '".$_POST['Supplier_id']."', Date_acquired ='".$_POST['Date_acquired']."', Status = '".$_POST['Status']."' WHERE Stock_id = ".$_POST['Stock_id']);
...
<form action="#" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="Expiry_date" name="Expiry_date" value="<?php echo $stocks_table['Expiry_date']; ?>" required></td>
            </tr>
            <tr>
                <td><label for="Supplier_id">Supplier Id:</label></td>
                <td><input type="text" id="Supplier_id" name="Supplier_id" value="<?php echo $stocks_table['Supplier_id']; ?>" required></td>
            </tr>
            <tr>
                <td><label for="Date_acquired">Date acquired:</label></td>
                <td><input type="text" id="Date_acquired" name="Date_acquired" value="<?php echo $stocks_table['Date_acquired']; ?>" required></td>
            </tr>
            <tr>
        ...
        <button><a href="Stock.php">Back</a></button> </h2>
    </form>
</body>