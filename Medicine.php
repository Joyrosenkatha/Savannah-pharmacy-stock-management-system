...
<script>
    ...
    function editMedicine(MedicineId) {
        ...
        window.location.href = 'Edit_medicine.php?Med_id=' + MedicineId;
    }
</script>
...
/* Style for new medicine records */
#addMedicine {
    text-align: center;
    margin-top: 5px;
}

/* Style for Medicine data records */
#medicineInformation {
    text-align: center;
    margin-top: 30px;
}
...
if(isset($_GET['search'])) {
  ...
  if($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
          ...
          echo "<td><button onclick=\"editMedicine('{$row['Med_id']}')\">Update</button>";
          echo "</tr>";
        }
