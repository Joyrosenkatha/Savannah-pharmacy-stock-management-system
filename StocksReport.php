<D html>
 ...
 <header>
    ...
    <form method="GET">
        <div>
            <label for="searchStockId">Search by Stock Id:</label>
            <input type="text" id="searchStockId" name="searchStockId">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" id="yearRangeFrom" name="yearRangeFrom" min="1900" max="2099" step="1" value="2024">
        </div>
        <div>
        ...
        <input type="number" id="yearRangeTo" name="yearRangeTo" min="1900" max="2099" step="1" value="2024">
    </div>
    <div>
...
<div>
    ...
    <div>
        ...
        <br>
        <br>
        <button><a href="StockList.php">Go Back</a></button>
    </div>
