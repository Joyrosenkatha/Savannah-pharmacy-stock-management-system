...
<script>
    ...
    function editStock(StockId) {
        ...
        window.location.href = 'Edit_stockList.php?Stock_id=' + StockId;
    }
</script>
...
<form method="GET" action="">
    <input type="text" name="search_query" placeholder="Search by Supplier id or Date acquired">
...
if(isset($_GET['search'])) {
  ...
  $sql = "SELECT * FROM stocks_table WHERE Supplier_id LIKE '%$search_query%' OR Date_acquired LIKE '%$search_query%'";
