...
if(isset($_POST['updatebtn'])){
    ...
    $updateQuery = $link->query("UPDATE patients_table SET Patient_name =  '".$_POST['Patient_name']."', Gender =  '".$_POST['Gender']."', DateOfBirth =  '".$_POST['DateOfBirth']."', Phone_number =  '".$_POST['Phone_number']."', National_id = '".$_POST['National_id']."', Address ='".$_POST['Address']."', City = '".$_POST['City']."', Date_added =  '".$_POST['Date_added']."' WHERE Patient_id = ".$_POST['Patient_id']);
...
<form action="#" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="date" id="DateOfBirth" name="DateOfBirth" value="<?php echo $patients_table['DateOfBirth']; ?>" required></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="National_id">National_id:</label></td>
                <td><input type="text" id="National_id" name="National_id" value="<?php echo $patients_table['National_id']; ?>" required></td>
            </tr>
            <tr>
        ...
        <button><a href="PatientsList.php">Back</a></button> </h2>
    </form>
</body>