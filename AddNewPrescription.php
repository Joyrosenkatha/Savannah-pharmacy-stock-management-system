...
session_start();
    ...
    if(isset($_POST['submit'])) {
        ...
        VALUES ('$Patient_id', '$Med_id', '$Dosage', '".$_SESSION['sessionUsername']."')";

        if ($link->query($sql) === TRUE) {
            echo "Record added successfully";
            header("Location: AddNewPrescription.php");
            exit();
        } else {
...
<html lang="en">
    ...
    <style>
        ...
        <form name="prescription_form" method="POST" action="AddNewPrescription.php">
            <table>
            <tr>
