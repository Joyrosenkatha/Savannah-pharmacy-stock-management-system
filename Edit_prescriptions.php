...
if(isset($_POST['updatebtn'])){
    ...
    $updateQuery = $link->query("UPDATE prescriptions_table SET Patient_name =  '".$_POST['Patient_name']."', Med_name =  '".$_POST['Med_name']."', Prescription_date =  '".$_POST['Prescription_date']."', Dosage = '".$_POST['Dosage']."', Doc_name ='".$_POST['Doc_name']."', Status = '".$_POST['Status']."' WHERE Prescription_id = ".$_POST['Prescription_id']);
...
<form action="#" method="post">
        ...
        <button><a href="Prescriptions.php">Back</a></button> 
    </form>
</body>