<!Doctype html>
 ...
 <header>
    ...
    <form method="GET">
            ...
            <tr>
            <td><label for="searchPatientId">Search by Patient Id:</label></td>
            <td><input type="text" id="searchPatientId" name="searchPatientId"></td>
    </tr>
    <tr>
        ...
        <tr>
            ...
            <td><select id="month" name="month">
                ...
                <?php
                //An associative array where keys are month numbers (1-12) and values are month names.
        ...
        <td><select id="monthRangeTo" name="monthRangeTo">
            <option value="">Select Month</option>
            <?php
            foreach ($months as $monthNum => $monthName) {
                echo "<option value='$monthNum'>$monthName</option>";
