...
if(isset($_POST['updatebtn'])){
    ...
    $updateQuery = $link->query("UPDATE patient_booking SET  `Doc_id` =  '".$_POST['Doc_id'].", Patient_id =  '".$_POST['Patient_id']."', Booking_status =  '".$_POST['Booking_status']."', Booking_status = '".$_POST['Booking_status']."', Booking_date ='".$_POST['Booking_date']."', Booking_time = '".$_POST['Booking_time']."' WHERE Booking_id = ".$_POST['Booking_id']);
    

    header("Location: Health_information_dashboard.php");
    ...
    <form action="#" method="POST" >
        ...
        <table>
            <tr>
                ...
                <td><input type="text" id="Doc_id" name="Doc_id" value="<?php echo $patient_booking['Doc_id']; ?>" required></td>
            </tr>
          
            <tr>
                <td><label for="Patient_id">Patient id:</label></td>
                <td><input type="text" id="Patient_id" name="Patient_id" value="<?php echo $patient_booking['Patient_id']; ?>" required></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="Booking_date" name="Booking_date" value="<?php echo $patient_booking['Booking_date']; ?>" required></td>
            </tr>
            <tr>
                <td><label for="Booking_time">Booking time:</label></td>
                <td><input type="text" id="Booking_time" name="Booking_time" value="<?php echo $patient_booking['Booking_time']; ?>" required></td>
            </tr>
        </table>
        <button type="submit" id="updatebtn" name="updatebtn" >Update Order</button>
        <button><a href="BookingList .php">Back</a></button> </h2>
    </form>
</body>
